...
class Restaurantone extends StatefulWidget {
  const Restaurantone({super.key});

  @override
  State<Restaurantone> createState() => _RestaurantoneState();
}

class _RestaurantoneState extends State<Restaurantone> {
  final products = [
    {
  ...
  Future<void> loadData() async {
    ...
    final doc = await FirebaseFirestore.instance.collection('Restaurantones').doc(uid).get();
    if (doc.exists) {
      final data = doc.data()!;
      setState(() {
